...
class TestUtil(unittest.TestCase):
    ...
    def test_validate_permissions_success(self):
        self.assertTrue(util.validate_permissions("3 * 3", "user1"))

    def test_validate_permissions_fail(self):
        self.assertFalse(util.validate_permissions("3 * 3", "user2"))
    ...
    def test_invalid_convert_to_number_fail(self):
